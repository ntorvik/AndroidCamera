...
import wb.android.google.camera.util.MediaSetUtils;
...
public abstract class ActivityBase extends AbstractGalleryActivity
    ...
    public ScreenNail createCameraScreenNail() {
        ...
        String path = "/local/all/0"; // Use 0 so gallery does not show anything.
    ...
    // Call this after setContentView.
    protected ScreenNail reuseCameraScreenNail() {
        mCameraAppView = findViewById(R.id.camera_app_root);
        Bundle data = new Bundle();
        String path = "/local/all/0"; // Use 0 so gallery does not show anything.
